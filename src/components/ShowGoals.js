  ...
  return (
    <div className="mx-10">
      <div className="flex justify-center items-center">
        <h1 className="text-2xl text-center text-blue-700 mt-10 mb-5 font-bold">
          Your Goals
        </h1>
        <span className="text-2xl text-center text-blue-700 ms-2 mt-10 mb-5 font-bold">
          <GoGoal />
        </span>
      </div>
      {goals.map((goal) => (
        <div
          key={goal.id}
          className="flex justify-between py-2 border border border-gray-400"
        >
          <div style={{ marginLeft: "30%" }}>
            <input type="checkbox" id={`goal-${goal.id}`} />
            <span className="text-lg font-medium">{goal.goal} </span>
          </div>
          <div style={{ marginRight: "30%" }}>
            <button
              onClick={() => {
                handleDeleteGoals(goal.id);
              }}
...
//                 className={`text-blue-500 hover:text-blue-700 font-medium ${
//                   isButtonDisabled(goals[index].id)
...
//               set goals section
//             </Link>
//             . Goals help us to keep focus and do well. Lorem ipsum dolor sit
//             amet consectetur adipisicing elit. Ab inventore quas dicta,
//             obcaecati minima repudiandae delectus ratione et nulla molestiae
//             voluptatum cumque dolorem vel perspiciatis iste suscipit eius autem
//             ipsum.
//           </h1>
//         )}
//       </div>
